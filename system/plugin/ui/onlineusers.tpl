        ...
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading">
				<div class="btn-group pull-right">
                    <form action="{$_url}plugin/online_users" method="post">
            ...
            <div class="panel-body">
                <div class="md-whiteframe-z1 mb20 text-center" style="padding: 15px">
                    <div class="col-md-8">
                        <form id="site-search" method="post" action="{$_url}plugin/online_users">
                                    ...
                                    <td>
                                        <div class="btn-group pull-right">
                                            <form action="{$_url}plugin/online_users" method="post">
												...
												<input type="hidden" name="dddd" value="{$userson['framedipaddress']}">
